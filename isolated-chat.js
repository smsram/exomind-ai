...
function handleMessageSubmit() {
    ...
    // Create a new div container for the user's message
    const userMessageContainer = document.createElement("div");
    userMessageContainer.classList.add("user-prompt-container-main"); // Add a class for styling if needed

    // Append user's message as a <p> inside the div
    ...
    fetchBotResponse(userInputValue);
}

// Function to fetch and display bot response
async function fetchBotResponse(userInputValue) {
    try {
        ...
        let responseContent = processResponse(data.response);

        // Remove typing indicator
        typingIndicator.remove();

        // Display bot response with fade-in animation
        const botMessageContainer = document.createElement("div");
        botMessageContainer.classList.add("bot-response-container");

        const responseText = document.createElement("p");
        responseText.innerHTML = responseContent;
        botMessageContainer.appendChild(responseText);
